...
trendHeatmap <- function(Top.Trendy){
  ...
  colnames(seg.all.id.highr.sign.sort) <- gsub(".Fitted.Trend", "", colnames(seg.all.id.highr.sign.sort), fixed=TRUE)
