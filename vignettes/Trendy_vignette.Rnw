...
<<eval=TRUE, warning=FALSE, fig.height=10, fig.width=10, fig.align='center', out.width='\\textwidth'>>=
par(mfrow=c(3,2))
...
<<eval=TRUE, warning=FALSE,fig.align='center'>>=
...
<<eval=TRUE, warning=FALSE, fig.height=10, fig.width=10, fig.align='center'>>=
par(mfrow=c(3,2))
...
the time course:
<<eval=TRUE, fig.height=10, fig.width=8>>=
par(mfrow=c(3,2))
...
<<eval=TRUE, warning=FALSE,fig.align='center', out.width='.8\\textwidth'>>=
# Genes that peak
...
<<eval=TRUE, warning=FALSE, fig.height=5, fig.width=10, fig.align='center', out.width='.8\\textwidth'>>=
# Get trend matrix:
